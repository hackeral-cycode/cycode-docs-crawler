# GitLab Runner | Cycode Docs

Source: https://docs.cycode.com/integrations/build-tools/gitlab-runner

---

# GitLab Runner

[](https://gitlab.com/cycodehq/documentation/cycode_docs/-/blob/main/src/content/integrations/build-tools/gitlab-runner.md "Edit this page")

Updated on Jan 24, 2025 • Published on Jan 24, 2025

* * *

## Permissions [Copied!](#permissions "Copy link to this section")

GitLab Runner are part of the GitLab integration and require the same [permissions](/integrations/scm-source-code-management-tools/gitlab#permissions) .
