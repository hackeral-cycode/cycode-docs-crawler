# SCA package card | Cycode Docs

Source: https://docs.cycode.com/scanners/ast-application-security-testing/sca-software-composition-analysis/sca-violations/sca-package-card

---

# SCA package card

[](https://gitlab.com/cycodehq/documentation/cycode_docs/-/blob/main/src/content/scanners/ast-application-security-testing/sca-software-composition-analysis/sca-violations/sca-package-card.md "Edit this page")

Updated on Feb 10, 2026 • Published on Jul 29, 2025

* * *

## Overview [Copied!](#overview "Copy link to this section")

The package card provides an easy way of navigating through the SCA violations, providing you with a clear vision and automatic aggregation of violations per package/dependency, and allowing you to immediately spot problematic packages/dependencies (those that have the most associated violations).
...
[Package health score](/scanners/ast-application-security-testing/sca-software-composition-analysis/sca-violations/sca-violation-card/sca-package-health-enrichment) assigned to this package.
...
The reachability feature contains information on vulnerable functions for specific vulnerabilities. If Cycode detects that a code project references this kind of package, the source code is scanned to check whether it calls vulnerable functions from this package.
...
To open the full query in the Context Intelligence Graph, click **see all in graph**.
...
Shows additional information about the package, such as the applicable software license.

### Risk analysis tab [Copied!](#risk-analysis-tab "Copy link to this section")

This tab shows how prioritizes violations and manages risks. The following information is displayed.
...
See the [SCA violation card](/scanners/ast-application-security-testing/sca-software-composition-analysis/sca-violations/sca-violation-card) risk factors for more information about these characteristics.
...
Type of dependency, either direct or indirect.
...
Click a row to open the SCA violation card for that violation.
