# Scan PRs for license compliance | Cycode Docs

Source: https://docs.cycode.com/scanners/ast-application-security-testing/sca-software-composition-analysis/configure-the-sca-scanner/scan-prs-for-license-compliance

---

# Scan PRs for license compliance

[](https://gitlab.com/cycodehq/documentation/cycode_docs/-/blob/main/src/content/scanners/ast-application-security-testing/sca-software-composition-analysis/configure-the-sca-scanner/scan-prs-for-license-compliance.md "Edit this page")
...
**Ignore non-permissive license use for this package in this pull request**

Developers can ignore non-permissive license use for the given package for this pull request using a comment.
...
#cycode\_ignore\_non\_permissive\_license\_use

Applies to this resource for this manifest for this package in this pull request only.
