# View and manage AI security violations | Cycode Docs

Source: https://docs.cycode.com/scanners/ai-security/view-and-manage-ai-security-violations

---

# View and manage AI security violations

[](https://gitlab.com/cycodehq/documentation/cycode_docs/-/blob/main/src/content/scanners/ai-security/view-and-manage-ai-security-violations.md "Edit this page")
...
## View the AI security violation list [Copied!](#view-the-ai-security-violation-list "Copy link to this section")

To view the AI security violations, go to **Violations > Modules > AI Security**. Cycode displays the following information about AI-related violations.
...
### AI security violation table [Copied!](#ai-security-violation-table "Copy link to this section")

The AI security view shows the following details about each violation. To drill through and view the violation card, click a row in the table.
...
## Manage AI security violations [Copied!](#manage-ai-security-violations "Copy link to this section")
