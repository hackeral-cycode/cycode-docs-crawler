...
Source: https://docs.cycode.com/context-intelligence-graph/inventory/application-insights/ai-security

---

# AI security

[](https://gitlab.com/cycodehq/documentation/cycode_docs/-/blob/main/src/content/context-intelligence-graph/inventory/application-insights/ai-security.md "Edit this page")
...
The AI security view provides comprehensive visibility into all AI technologies detected across your organization’s codebase and infrastructure. This unified view helps security teams identify, monitor, and govern AI tool usage to ensure compliance and reduce risk.
...
For information about the other tabs in the inventory card, go to [Technologies](/context-intelligence-graph/inventory/application-insights/technologies) .
...
For information about the other tabs in the card, go to [Secret values](/context-intelligence-graph/inventory/application-insights/secret-values) .
...
For information about the other tabs in the card, go to [Packages](/context-intelligence-graph/inventory/code-entities/packages) .
