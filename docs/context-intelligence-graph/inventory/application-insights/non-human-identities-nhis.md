...
Source: https://docs.cycode.com/context-intelligence-graph/inventory/application-insights/non-human-identities-nhis

---

# Non-Human Identities (NHIs)

[](https://gitlab.com/cycodehq/documentation/cycode_docs/-/blob/main/src/content/context-intelligence-graph/inventory/application-insights/non-human-identities-nhis/_index.md "Edit this page")
