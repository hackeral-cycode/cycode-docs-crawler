...
Source: https://docs.cycode.com/inventory/application-insights/technologies

---

# Technologies

[](https://gitlab.com/cycodehq/documentation/cycode_docs/-/blob/main/src/content/inventory/application-insights/technologies.md "Edit this page")
...
The Inventory tab lists all the assets associated with the technology. The tab contains four sub-tabs, each showing a different asset type:
...
Lists all repositories linked to this technology. The table displays the repository **Name** and **Visibility** (for example, Private or Public).

**Container Images**

Lists all container images associated with this technology.

**Container Repositories**

Lists all container repositories associated with this technology. The table displays the repository **Name** and **Provider**.

**Build Workflows**

Lists all build workflows associated with this technology. The table displays the workflow **Name** and **Provider**.

Each sub-tab includes a **Search** bar to filter results by name and displays the total result count. Click any row in the list to view more details about the specific asset.
